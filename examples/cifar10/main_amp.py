...
def save_checkpoint(state, is_best, ckpt, filename='checkpoint.e{}.tar'):
    ckpt_file = ckpt + '/' + filename.format(state['epoch'])
    torch.save(state, ckpt_file)
    if is_best:
        shutil.copyfile(ckpt_file, 'model_best.e{}.tar'.format(state['epoch']))
